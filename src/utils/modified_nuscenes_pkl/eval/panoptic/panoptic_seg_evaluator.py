...
import numpy as np
from nuscenes.eval.panoptic.panoptic_seg_evaluator import PanopticEval as Pev


# Done, Done

class PanopticEval(Pev):
    ...
    def __init__(self, n_classes, ignore=None, offset=2 ** 32, min_points=30):
        super().__init__(n_classes, ignore=ignore, offset=offset, min_points=min_points)
