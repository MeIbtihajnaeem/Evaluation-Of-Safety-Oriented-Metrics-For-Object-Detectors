...
class Box:
    ...
    def __init__(self,
        ...
        self.vel = vel
        self.obj_translation = obj_translation
    ...
    def render_debug_1(self,
        ...
        # print("utils.data_classes_tests.py: "+str(self.name))

        # calcolo e visualizzo speed e traslation di un vehicle
        stampa_obj = "v: [" + str("%.2f" % self.vel[0]) + ", " + str("%.2f" % self.vel[1]) + "]; tr: [" + str(
            "%.2f" % self.obj_translation[0]) + ", " + str("%.2f" % self.obj_translation[1]) + "]"
        axis.text(corners.T[0][0], corners.T[0][1], stampa_obj, color=colors[0], fontsize=12)
    ...
    def render_crit(self,
        ...
        """
        rendered_classes = [
            'car']  #, 'truck', "bus", "trailer", "construction_vehicle", "motorcycle", "bicycle", "pedestrian","barrier"]
        ...
        for i in range(4):
            axis.plot([corners.T[i][0], corners.T[i + 4][0]],
                      [corners.T[i][1], corners.T[i + 4][1]],
                      color=colors[2], linewidth=linewidth)
        #here I add the crit value to the plot
